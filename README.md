...
#spike { position: absolute; right:20px; top:45%; width:40px; height:40px; background:red; clip-path: polygon(50% 0%, 100% 100%, 0% 100%); z-index:1000; }
...
function checkButtonCollision(){
    ...
    p.b.forEach(b=>{
        ...
        const overlap=!(ballRight<spike.left||ballLeft>spike.right||ballBottom<spike.top||ballTop>spike.bottom);
